...
async function startProfessionalAnalysis(name, gender, displayTypeName, year, month, day, fortuneType, maritalStatus, calendarType) {
    ...
    const promptText = `
        ...
        반드시 아래 JSON 형식으로만 응답해. (다른 텍스트 절대 불가, 따옴표나 줄바꿈에 주의할 것)
        {
            ...
            "free": "<div class='free-preview' style='background: rgba(0,0,0,0.6); border: 1px solid rgba(212, 175, 55, 0.4); border-radius: 15px; padding: 30px 20px; text-align: center; margin-bottom: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.5);'><h3 style='color:#D4AF37; margin-bottom:25px; font-size: 1rem; letter-spacing: 3px;'>[ 운 명 요 약 ]</h3><div style='margin-bottom: 30px; line-height: 1.4;'><div style='font-size: 1.7rem; font-weight: 900; background: linear-gradient(to bottom, #FFFDE4, #D4AF37); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: 8px; text-shadow: 0px 2px 10px rgba(0,0,0,0.5);'>(분석을 관통하는 거대한 핵심 키워드 1 - 예: 거대한 조력자)</div><div style='font-size: 2.2rem; font-weight: 900; background: linear-gradient(to bottom, #FFE066, #F9A826); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: 8px; text-shadow: 0px 4px 15px rgba(0,0,0,0.8);'>(가장 강력한 운명의 특징 2 - 예: 제왕의 기틀)</div><div style='font-size: 1.7rem; font-weight: 900; background: linear-gradient(to bottom, #FFFDE4, #D4AF37); -webkit-background-clip: text; -webkit-text-fill-color: transparent; text-shadow: 0px 2px 10px rgba(0,0,0,0.5);'>(앞으로 다가올 변화 3 - 예: 중차대한 전환점)</div></div><p style='color:#e0e0e0; font-size: 1.05rem; line-height: 1.8; text-align: justify; word-break: keep-all; margin: 0;'>(이곳에 무료공개용 사주 요약 3~4문장을 아주 무게감 있게 작성해. 단, 문장 속에서 가장 중요한 명사나 핵심 단어 양옆에는 반드시 <strong style='color:#FFDF73; font-weight:bold; background: rgba(212, 175, 55, 0.1); padding: 0 4px;'>핵심단어</strong> 형태로 금색 강조 태그를 씌워줄 것)</p></div>",
